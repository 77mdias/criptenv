      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              "flex h-10 w-full rounded-lg border bg-[var(--surface)] px-3 py-2 text-base md:text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] transition-colors",
