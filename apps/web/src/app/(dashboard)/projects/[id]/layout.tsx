      ...
      <Card className="border-red-500/40 p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 font-mono text-sm leading-relaxed text-red-600">
              {message}
            </p>
          </div>
        </div>
...
export default function ProjectDetailLayout({
  ...
  const cachedProject = projectId
    ? peekCached<Project>(`/api/v1/projects/${projectId}`)
    : null;
      ...
      <div className="space-y-4">
        ...
        <Card className="p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-(--background-muted) text-(--text-primary)">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-2 max-w-2xl font-mono text-sm leading-relaxed text-(--text-tertiary)">
                  {project.description ||
