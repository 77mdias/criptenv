...
**Observações:**
- Escopo confirmado: usuários sem conta continuam recebendo apenas o convite por email.
- A correção não altera endpoints nem schema de banco.
...
- Uploads não dependem de anon key nem de policies do bucket porque passam pelo backend com service role.
